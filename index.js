...
function addGamesToPage(games) {
    ...
    for (let i = 0; i < games.length; i++) {
        ...
        gameCard.innerHTML = `
            <h2>${games[i].name}</h2>
            <img src="${games[i].img}" alt="${games[i].name}" class="game-image" width="200" height="200">
...
const str = "The number of unfunded games is " + numUnfundedGames;


// create a new DOM element containing the template string and append it to the description container
const newDescriptionElement = document.createElement("p");
newDescriptionElement.textContent = str;
descriptionContainer.appendChild(newDescriptionElement);
